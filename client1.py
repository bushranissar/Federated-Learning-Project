...
def evaluate_local(
    ...
    client1_accuracy_history.append(
        results["accuracy"]
    )

    client1_loss_history.append(
        results["loss"]
    )

    client1_precision_history.append(
        results["precision"]
    )

    client1_recall_history.append(
        results["recall"]
    )

    client1_f1_history.append(
        results["f1_score"]
    )

    client1_cnn_accuracy_history.append(
        cnn_accuracy
    )

    client1_svm_accuracy_history.append(
        svm_accuracy
    )
